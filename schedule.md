...
||Reading <br> (10 min) | Chapter 1: Introduction from {{site.hcibook}}  | Basic structure of a user interface | 
||Reading <br> (10 min) | Chapter 3; 9-10: Understanding Android Application and Activity Lifecycles from {{site.androidbook}} | Getting up to speed on Android | 
