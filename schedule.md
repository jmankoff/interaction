...
||Reading <br> (10 min) | Chapter 1: Introduction from [Building Interactive Systems](https://www.amazon.com/dp/1423902483/ref=rdr_ext_sb_ti_hist_1)  | Basic structure of a user interface | 
||Reading <br> (10 min) | Chapter 3; 9-10: Understanding Android Application and Activity Lifecycles from [Android Studio 3.0 Development Essentials](https://www.amazon.com/dp/1977540090/ref=rdr_ext_tmb)| Getting up to speed on Android | 
||Preparation (10-20 min) | Download Android Studio and follow the directions in Chapter 3 to create an Android Application (also see these [instructions](setup-android.html)) | Getting up to speed on Android |
||Reading Quiz|[On Canvas](https://canvas.uw.edu/courses/1259568), due night before|
||Exercise Assigned | [Doodle](/interaction/assignments/doodle)| Getting up to speed on Android; Basics of drawing on the screen | 
||Slides | [Core Toolkit Abstractions](/interaction/slides/wk01/MVC.html)|  Basic structure of a user interfaces; Common interactors|
...
||Reading (10 min)| Chapter 2 from Drawing from [Building Interactive Systems](https://www.amazon.com/dp/1423902483/ref=rdr_ext_sb_ti_hist_1)| Basic drawing abstractions | 
||Reading Quiz|[On Canvas](https://canvas.uw.edu/courses/1259568), due night before|
...
||Required Reading (10 min)| Chapter 17 & 18: A Guide to Android Constraint Layout [Android Studio 3.0 Development Essentials](https://www.amazon.com/dp/1977540090/ref=rdr_ext_tmb)| Android's approach to layout 
||Reading Quiz|[On Canvas](https://canvas.uw.edu/courses/1259568), due night before|
...
||Required Reading (10 min)|Chapter 3: Event Handling [Building Interactive Systems](https://www.amazon.com/dp/1423902483/ref=rdr_ext_sb_ti_hist_1) pp. 43-52 (on Input Events); 59-63 (Listeners)| Basics of event handling including event types and listeners
||Reading Quiz|[On Canvas](https://canvas.uw.edu/courses/1259568), due night before|
...
||Required Reading|Chapter 11: Input Syntax Specification [Building Interactive Systems](https://www.amazon.com/dp/1423902483/ref=rdr_ext_sb_ti_hist_1)| Essential Behavior and the use of final state machines to implement it |
...
|      |Video Watching Quiz|[On Canvas](https://canvas.uw.edu/courses/1259568), due night before|
...
# Week 5:  Implementing Physical Interactors
